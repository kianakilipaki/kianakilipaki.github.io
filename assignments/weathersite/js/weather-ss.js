...
let apiURLstring = 'https://api.openweathermap.org/data/2.5/weather?id=5607916&units=imperial&APPID=6fee2cd00a7486172b7361fc5471afb6';
weatherRequest.open('Get', apiURLstring, true);
weatherRequest.send();

// create forecast weather request variable
let forecastRequest = new XMLHttpRequest();
let apiURLstringF = 'https://api.openweathermap.org/data/2.5/forecast?id=5607916&units=imperial&APPID=6fee2cd00a7486172b7361fc5471afb6';
